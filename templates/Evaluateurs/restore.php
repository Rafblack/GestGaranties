...
<section class="content-header">
    <h1>Restoration - Evaluateur(trice)</h1>
</section>
<div class="content">
    <div class="row">
            ...
            <?php else :?>
                ...
                <?php endif ;?>
                    ...
                    <?php if($tel == null):?>
                     ...
                     <?= $this->Form->control('tel', [ 'class' => 'form-control',"label"=> "telephone plus disponible entrez un nouveau", "required"=> true, "value"=>""])?>



              <?php else :?>

                     <?= $this->Form->control('tel', ['label' => 'Téléphone', 'class' => 'form-control',"readonly"=> true, "value"=> $tel])?>
    ...
    <?php endif ;?>
                    ...
                    <p>Si la case est modifiable, c'est parce que la valeur a été attribuée à un(e) autre évaluateur(trice).</p>
                    </div>
                </div>
            </div>
    </div>
